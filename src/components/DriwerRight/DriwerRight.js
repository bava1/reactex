      ...
      <Drawer classes={{ width: 250 }}  anchor="right" open={open} onClose={toggleDrawer(false)}>
        <div className="draw">
          ...
          <div className="draw-main">
            ...
            <AssessmentRoundedIcon /><Link to='/tasks' onClick={toggleDrawer(false)} className="draw-nav_main-link" >Tasks</Link><br /><br />
            <ViewListRoundedIcon /><Link to='/articles' onClick={toggleDrawer(false)} className="draw-nav_main-link" >Articles</Link><br /><br />
            <OfflineBoltRoundedIcon /><Link to='/about' onClick={toggleDrawer(false)} className="draw-nav_main-link" >About</Link><br /><br />
